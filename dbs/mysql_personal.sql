-- `tc-db-main`.personal definition

CREATE TABLE `personal` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `PARENT_ID` int(11) DEFAULT NULL,
  `TYPE` enum('DEP','EMP') DEFAULT NULL,
  `EMP_TYPE` enum('EMP','GUEST','AUTO_PERSONAL','AUTO_OFFICIAL') DEFAULT 'EMP',
  ...
  `STATUS` enum('AVAILABLE','FIRED','INTERNAL') DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=14646 DEFAULT CHARSET=latin1;